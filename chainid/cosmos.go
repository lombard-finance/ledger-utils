...
func NewCosmosLChainId(chainId string) (CosmosLChainId, error) {
	if chainId == "" {
		return CosmosLChainId{}, fmt.Errorf("%w: %w", ErrInvalidCosmosChainId, ErrEmptyCosmosChainId)
	}
	...
	if lastDashPosition != -1 {
		...
		if err != nil {
			return CosmosLChainId{}, fmt.Errorf("%w: cannot find counter in provided chain id", ErrInvalidCosmosChainId)
		}
...
func NewLombardLedgerLChainId() CosmosLChainId {
	return CosmosLChainId{
		lChainId: lChainId{
			inner: [32]byte{0x03, 0x87, 0xb2, 0x5e, 0x8e, 0x61, 0xf2, 0xce, 0x48, 0x38, 0xb0, 0x47, 0x95, 0xb2, 0x31, 0xf0, 0x9e, 0xe7, 0x3f, 0xfd, 0x39, 0x1d, 0xa0, 0x18, 0xbe, 0xf4, 0xbc, 0x5c, 0x49, 0x75, 0x89, 0x7b},
		},
	}
}
...
func NewOsmosisLChainId() CosmosLChainId {
	return CosmosLChainId{
		lChainId: lChainId{
			inner: [32]byte{0x03, 0x8e, 0xbf, 0xb6, 0x51, 0x9e, 0x8d, 0x81, 0x4f, 0x1b, 0x8a, 0xee, 0x62, 0xda, 0x9a, 0x4e, 0x17, 0x3f, 0x7e, 0x68, 0x98, 0xd6, 0x0d, 0x96, 0x20, 0x42, 0x42, 0x1d, 0x18, 0xdb, 0xe4, 0xef},
		},
	}
}
...
func NewCosmosHubLChainId() CosmosLChainId {
	return CosmosLChainId{
		lChainId: lChainId{
			inner: [32]byte{0x03, 0xa2, 0x32, 0x77, 0x9a, 0x42, 0x37, 0x21, 0xbf, 0xb8, 0x0a, 0x99, 0xe8, 0x68, 0x28, 0x03, 0x4a, 0xa5, 0x72, 0x6c, 0x46, 0x9f, 0x77, 0x0d, 0x39, 0xf2, 0x9a, 0x0f, 0xb4, 0x71, 0x0f, 0x9a},
		},
	}
}
...
func NewBabylonLChainId() CosmosLChainId {
	return CosmosLChainId{
		lChainId: lChainId{
			inner: [32]byte{0x03, 0x58, 0xed, 0x74, 0xe1, 0x57, 0x32, 0x57, 0x90, 0x4a, 0x3b, 0x76, 0x3e, 0x53, 0x36, 0x1d, 0xbf, 0x35, 0x6e, 0x7a, 0x01, 0xfe, 0x98, 0xb6, 0xe1, 0x5e, 0x91, 0xb7, 0x9c, 0x16, 0xcb, 0x80},
		},
	}
}

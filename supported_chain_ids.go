...
// NewEVMEthereumChainId returns the ChainId for the Ethereum blockchain
...
// NewEVMHoleskyChainId returns the ChainId for the Ethereum Holesky blockchain
...
// NewEVMSepoliaChainId returns the ChainId for the Ethereum Sepolia blockchain
...
// NewEVMBinanceSmartChainChainId returns the ChainId for the Binance Smart Chain blockchain
...
// NewEVMBaseChainId returns the ChainId for the Base blockchain
...
// NewEVMBaseSepoliaChainId returns the ChainId for the Base Sepolia blockchain
...
// NewBitcoinChainId returns the ChainId for the Bitcoin blockchain
func NewBitcoinChainId() ChainId {
	return ChainId{
...
// NewBitcoinSignetChainId returns the ChainId for the Bitcoin Signet blockchain
func NewBitcoinSignetChainId() ChainId {
	return ChainId{
